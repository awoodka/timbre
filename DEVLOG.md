...
- **Left off at:** committed as `added a way to add new media`. Remaining backlog: **rec feedback** (+ polish / bigger swings). Pre-deploy reminders stand (real `SECRET_KEY`, `Secure` cookies, `npm audit`).
